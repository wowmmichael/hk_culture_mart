    ...
    <MainLayout>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-gray-900">香港風格萬聖節</h2>
        ...
        <div className="bg-white border border-gray-200 p-8 rounded-lg mb-12 shadow-sm">
          <h3 className="text-2xl font-semibold mb-4 text-gray-800">萬聖節精選</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
              <h4 className="font-medium text-lg mb-2 text-gray-800">裝飾品</h4>
              <p className="text-gray-700">
                結合中國傳統元素與萬聖節氣氛的獨特裝飾品。
              </p>
            </div>
            <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
              <h4 className="font-medium text-lg mb-2 text-gray-800">服裝道具</h4>
              <p className="text-gray-700">
                創意十足的萬聖節服裝與道具，融合東西方元素。
              </p>
            </div>
            <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
              <h4 className="font-medium text-lg mb-2 text-gray-800">特別版玩具</h4>
              <p className="text-gray-700">
