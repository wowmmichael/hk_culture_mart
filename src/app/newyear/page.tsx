    ...
    <MainLayout>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-gray-900">迎接農曆新年</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-xl font-semibold mb-3 text-red-700">新年飾品</h3>
            <p className="text-gray-700">
              春聯、燈籠、窗花等傳統新年裝飾，讓您的家充滿節日氣氛。
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-xl font-semibold mb-3 text-red-700">新年禮盒</h3>
            <p className="text-gray-700">
              精美的禮盒包裝，內含各種傳統糖果、餅乾和茶葉，是拜訪親友的最佳選擇。
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-xl font-semibold mb-3 text-red-700">限定玩具</h3>
            <p className="text-gray-700">
